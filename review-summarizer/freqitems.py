...
def get_transactions_from_file(reviews):
...
def generate_itemsets(itemsets_list, min_sup, min_atm,transactions):
...
def getfrequentitems(reviews):
    ...
    transactions = get_transactions_from_file(reviews)
    ...
    # generate itemsets of length > 1
    generate_itemsets(itemsets_list, min_sup, min_atm,transactions)
    print_results(itemsets_list,None,transactions)
